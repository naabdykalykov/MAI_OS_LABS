...
int main() {
    ...
    while(1) {
        ...
        // Если конец файла был достигнут и ни один символ не был прочитан, содержимое string остается неизменными и возвращается нулевой указатель. 
        ...
        // strcspn для поиска первого вхождения символа, возвращает индекс
        // в моём коде используется для получения индекса и последующей замены по индексу
        input[strcspn(input, "\n")] = '\0';
